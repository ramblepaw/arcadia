// Card model and deck construction for FreeCell.
//
// Standard 52-card deck, no Jokers, ranks 1..13 where 1=Ace, 11=J, 12=Q,
// 13=K. Every card is dealt face-up - FreeCell is a fully open-information
// game, there is no hidden state anywhere.
...
function makeCard(suit, rank) {
  __cardIdCounter += 1;
  return { id: `fc${__cardIdCounter}`, suit, rank };
}
